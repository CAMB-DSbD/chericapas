 ...
 * 
 * Program: capoffsetexception.c  
 *          Demonstrates how cheri capabilities can protect violations
 *          of memory bounds.
 ...
 *
 * Compilation: % cc -g -O2 -Wall -o capoffsetexception capoffsetexception.c 
 * Execution:   % ./capoffsetexception
 */
